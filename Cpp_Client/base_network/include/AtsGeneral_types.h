...
typedef struct _ConnectionMsg__isset {
  _ConnectionMsg__isset() : Name(false), Status(false), TradingAllowed(false), New(false), Mod(false), Can(false), Ack(false), Rej(false), NAck(false), Exe(false) {}
  bool Name :1;
  bool Status :1;
...
class ConnectionMsg {
 public:
  ...
  ConnectionMsg() : Name(), Status(( ::AtsType::ConnectionStatus::type)0), TradingAllowed(0), New(0), Mod(0), Can(0), Ack(0), Rej(0), NAck(0), Exe(0) {
  }
...
typedef struct _PositionMsg__isset {
  _PositionMsg__isset() : Instrument(false), Portfolio(false), YesterdayPosition(false), TodayPosition(false), TotalPosition(false), TodayBuyPosition(false), TodayBuyPrice(false), TodaySellPosition(false), TodaySellPrice(false), YesterdayPrice(false), YesterdayPriceLocal(false), YesterdayPriceExternal(false), YesterdayPositionLocal(false), YesterdayPositionManual(false), YesterdayPositionExternal(false), UseManualPosition(false), YstPositionType(false), YstPriceType(false), Connection(false), TodayPurPosition(false), TodayRedPosition(false) {}
  bool Instrument :1;
  bool Portfolio :1;
...
typedef struct _FeedMsg__isset {
  _FeedMsg__isset() : Code(false), FeedSourceName(false), Bid(false), Ask(false), BidQuantity(false), AskQuantity(false), Last(false), LastQuantity(false), LastOrClose(false), Mid(false), Close(false), Settlement(false), UpperLimit(false), LowerLimit(false), Perf(false), DailyVolume(false), isBiddAskActive(false), isSuspended(false), MaxDepth(false), BidDepths(false), AskDepths(false), BidQtys(false), AskQtys(false) {}
  bool Code :1;
...
class FeedMsg {
 public:
  ...
  FeedMsg() : Code(), FeedSourceName(), Bid(0), Ask(0), BidQuantity(0), AskQuantity(0), Last(0), LastQuantity(0), LastOrClose(0), Mid(0), Close(0), Settlement(0), UpperLimit(0), LowerLimit(0), Perf(0), DailyVolume(0), isBiddAskActive(0), isSuspended(0), MaxDepth(0) {
  }
