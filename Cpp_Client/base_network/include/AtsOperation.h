...
class AtsOperationIf {
 public:
  ...
  virtual bool CreateManualOrder(const double price, const  ::AtsType::OrderWay::type way, const int32_t quantity, const std::string& atsName, const std::string& atsInstrumentCode, const int32_t tradingtype, const  ::AtsType::OrderRestriction::type orderrestriction, const  ::AtsType::OrderOpenClose::type openclose) = 0;
...
class AtsOperationNull : virtual public AtsOperationIf {
 public:
  ...
  bool CreateManualOrder(const double /* price */, const  ::AtsType::OrderWay::type /* way */, const int32_t /* quantity */, const std::string& /* atsName */, const std::string& /* atsInstrumentCode */, const int32_t /* tradingtype */, const  ::AtsType::OrderRestriction::type /* orderrestriction */, const  ::AtsType::OrderOpenClose::type /* openclose */) {
    bool _return = false;
    return _return;
  }
...
typedef struct _AtsOperation_CreateManualOrder_args__isset {
  _AtsOperation_CreateManualOrder_args__isset() : price(false), way(false), quantity(false), atsName(false), atsInstrumentCode(false), tradingtype(false), orderrestriction(false), openclose(false) {}
  bool price :1;
  bool way :1;
  bool quantity :1;
  bool atsName :1;
...
class AtsOperation_CreateManualOrder_args {
 public:
  ...
  AtsOperation_CreateManualOrder_args() : price(0), way(( ::AtsType::OrderWay::type)0), quantity(0), atsName(), atsInstrumentCode(), tradingtype(0), orderrestriction(( ::AtsType::OrderRestriction::type)0), openclose(( ::AtsType::OrderOpenClose::type)0) {
  }
...
class AtsOperationClient : virtual public AtsOperationIf {
 ...
 public:
  ...
  bool CreateManualOrder(const double price, const  ::AtsType::OrderWay::type way, const int32_t quantity, const std::string& atsName, const std::string& atsInstrumentCode, const int32_t tradingtype, const  ::AtsType::OrderRestriction::type orderrestriction, const  ::AtsType::OrderOpenClose::type openclose);
  void send_CreateManualOrder(const double price, const  ::AtsType::OrderWay::type way, const int32_t quantity, const std::string& atsName, const std::string& atsInstrumentCode, const int32_t tradingtype, const  ::AtsType::OrderRestriction::type orderrestriction, const  ::AtsType::OrderOpenClose::type openclose);
...
class AtsOperationMultiface : virtual public AtsOperationIf {
 ...
 public:
  ...
  bool CreateManualOrder(const double price, const  ::AtsType::OrderWay::type way, const int32_t quantity, const std::string& atsName, const std::string& atsInstrumentCode, const int32_t tradingtype, const  ::AtsType::OrderRestriction::type orderrestriction, const  ::AtsType::OrderOpenClose::type openclose) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->CreateManualOrder(price, way, quantity, atsName, atsInstrumentCode, tradingtype, orderrestriction, openclose);
    }
    return ifaces_[i]->CreateManualOrder(price, way, quantity, atsName, atsInstrumentCode, tradingtype, orderrestriction, openclose);
  }
...
class AtsOperationConcurrentClient : virtual public AtsOperationIf {
 ...
 public:
  ...
  bool CreateManualOrder(const double price, const  ::AtsType::OrderWay::type way, const int32_t quantity, const std::string& atsName, const std::string& atsInstrumentCode, const int32_t tradingtype, const  ::AtsType::OrderRestriction::type orderrestriction, const  ::AtsType::OrderOpenClose::type openclose);
  int32_t send_CreateManualOrder(const double price, const  ::AtsType::OrderWay::type way, const int32_t quantity, const std::string& atsName, const std::string& atsInstrumentCode, const int32_t tradingtype, const  ::AtsType::OrderRestriction::type orderrestriction, const  ::AtsType::OrderOpenClose::type openclose);
