    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->ystPositionType = ( ::AtsType::YesterdayPositionType::type)ecast137;
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = ( ::AtsType::YesterdayPositionType::type)ecast138;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = ( ::AtsType::YesterdayPositionType::type)ecast139;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->ystPositionType = ( ::AtsType::YesterdayPositionType::type)ecast140;
          this->__isset.ystPositionType = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = ( ::AtsType::YesterdayPositionType::type)ecast141;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = ( ::AtsType::YesterdayPositionType::type)ecast142;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->way = ( ::AtsType::OrderWay::type)ecast143;
      ...
      case 7:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->orderrestriction = ( ::AtsType::OrderRestriction::type)ecast144;
      ...
      case 8:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->openclose = ( ::AtsType::OrderOpenClose::type)ecast145;
...
bool AtsOperationClient::CreateManualOrder(const double price, const  ::AtsType::OrderWay::type way, const int32_t quantity, const std::string& atsName, const std::string& atsInstrumentCode, const int32_t tradingtype, const  ::AtsType::OrderRestriction::type orderrestriction, const  ::AtsType::OrderOpenClose::type openclose)
{
  send_CreateManualOrder(price, way, quantity, atsName, atsInstrumentCode, tradingtype, orderrestriction, openclose);
  return recv_CreateManualOrder();
}

void AtsOperationClient::send_CreateManualOrder(const double price, const  ::AtsType::OrderWay::type way, const int32_t quantity, const std::string& atsName, const std::string& atsInstrumentCode, const int32_t tradingtype, const  ::AtsType::OrderRestriction::type orderrestriction, const  ::AtsType::OrderOpenClose::type openclose)
{
  int32_t cseqid = 0;
...
void AtsOperationProcessor::process_CreateManualOrder(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->CreateManualOrder(args.price, args.way, args.quantity, args.atsName, args.atsInstrumentCode, args.tradingtype, args.orderrestriction, args.openclose);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
...
{
  int32_t seqid = send_CreateManualOrder(price, way, quantity, atsName, atsInstrumentCode, tradingtype, orderrestriction, openclose);
