...
const std::map<int, const char*> _OrderWay_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(13, _kOrderWayValues, _kOrderWayNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
const std::map<int, const char*> _InstrType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(13, _kInstrTypeValues, _kInstrTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
