...
public:
	Sim_Client_API()
	{
		...
		function0<void> f2 = boost::bind(&Sim_Client_API::get_packet_from_cpp_lib, this);
		boost::thread t2(f2);
		this->sim_lib_thread = &t2;

		function0<void> f = boost::bind(&Sim_Client_API::processTask, this);
		boost::thread t(f);
		this->task_thread = &t;
	...
	void process_SimpleAtsMsg(Task task);
